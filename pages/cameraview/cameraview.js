    ...
    createRoom: function () {
      ...
      rtcroom.createRoom({
        ...
        success: function (ret) {
          ...
          wx.hideLoading();
          wx.request({
            url: 'https://survey.zhongchebaolian.com/boot-zcbl-survey-api/mock/weixin/video/connect',
            method: "post",
            data: {
              "surveyNo": "1234543534534534"
            },
            header: {
            ...
            success: function (res) {
              ...
              if (res.data.data.bindIdleCode == 200) {
                ...
                res.data.data.roomID = getApp().data.roomID;
                var dataObj = JSON.stringify(res.data.data)
                //创建房间并向web端发送消息
                console.log("dataObj" + dataObj)
                webimhandler.sendCustomMsgtext(dataObj)
              } else {
